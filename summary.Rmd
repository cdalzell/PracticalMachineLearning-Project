...
Training accuracy (in %): `r modelFit$results[2,2] * 100`
Training errors (in %:) `r 100 - (modelFit$results[2,2] * 100)`
...
The actual out of sample error is (in %): `r (1-as.numeric(validationAccuracy[1])) * 100`
